...
plot4 <- function() {
	...
	# mfrow=c(nrows, ncols) to create a matrix of nrows
	# by ncols. We want to disply 4 plots so we want
	# 2 by 2.
	#
	par(mfrow=c(2,2))

	#
	# Date/time vs. Global_active_power
	#
	# type='l' what type of plot? 'l' for lines
	#
	...
	# type='l' what type of plot? 'l' for lines
	#
	plot(clean_data$Time, clean_data$Voltage, type="l",
	...
	# type='l' what type of plot? 'l' for lines
	#
	plot(clean_data$Time, clean_data$Sub_metering_1, type="l", col="black",
	...
	#
	# type='n' what type of plot? 'n' for no plotting
	#
	plot(clean_data$Time, clean_data$Global_reactive_power, type="n",
		xlab="datetime", ylab="Global_reactive_power")

	#
	# Add date/time vs. Global_reactive_power
	#
